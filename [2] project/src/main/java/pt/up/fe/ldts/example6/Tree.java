...
public class Tree {
    ...
    public Tree(Date plantedAt, String locationLatitude, String locationLongitude, String locationName){
        ...
        this.location.setLocation(locationLatitude, locationLongitude, locationName);
        this.appraisalDates = new ArrayList<>();
    }

    public String toString() {
        return "Tree planted at " + this.plantedAt.toString() + " in location " + this.location.locationLatitude + "," + this.location.locationLongitude + " (" + this.location.locationName + ")";
    }
